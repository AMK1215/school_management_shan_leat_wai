    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-primary-100 mt-1">Here's what's happening at your school today.</p>
            </div>
        ...
        <div class="card p-6 animate-fade-in">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-success-600 dark:text-success-400">+12% from last month</p>
                </div>
            </div>
        </div>
        ...
        <div class="card p-6 animate-fade-in" style="animation-delay: 0.1s">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-success-600 dark:text-success-400">+3 new this month</p>
                </div>
            </div>
        </div>
        ...
        <div class="card p-6 animate-fade-in" style="animation-delay: 0.2s">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-success-600 dark:text-success-400">+2.1% from last week</p>
                </div>
            </div>
        </div>
        ...
        <div class="card p-6 animate-fade-in" style="animation-delay: 0.3s">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900 dark:text-white">$45,678</p>
                    <p class="text-sm text-success-600 dark:text-success-400">+8.2% from last month</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-4">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-gray-900 dark:text-white">New student enrolled: John Doe</p>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-gray-900 dark:text-white">Monthly fees collected: $12,450</p>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm text-gray-900 dark:text-white">Low attendance alert: Class 10A</p>
